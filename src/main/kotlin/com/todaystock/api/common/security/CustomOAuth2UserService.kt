...
class CustomOAuth2UserService(
    ...
    override fun loadUser(userRequest: OAuth2UserRequest): OAuth2User {
        ...
        val (email, name, picture, provider) =
                when (clientName) {
                    ...
                    "KAKAO" -> {
                        ...
                        val picture = profile?.get("profile_image_url") as? String
        ...
        val member =
                memberRepository.findByMemberId(MemberId(email, provider))
        ...
        // ROLE_USER 기본 부여
        val authorities =
                delegateUser.authorities.takeIf { it.isNotEmpty() }
